...
public class VAUProtocol_GF_RSASignaturVomClientTest {
  ...
  public void initialize() throws Exception {
    ...
    client = new VAUProtocol(new VAUProtocolCryptoImpl(false), new VAUProtocolSession(true));
  }
  ...
  @Test
  public void generateServerError() throws Exception {
    String errorMessage = server.generateVAUServerErrorMessage("My error message.");
