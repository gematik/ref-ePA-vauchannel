...
// [17072]
public class VAUProtocol_FinishedDataVomClientDefektTest {
  ...
  public void handshake() throws Exception {
    ...
    byte[] dataBytes = decode(vAUClientSigFin.getFinishedData());
    if (dataBytes[0] == (byte) 2) {
      dataBytes[0] = (byte) 3;
    } else {
      dataBytes[0] = (byte) 2;
    }
    vAUClientSigFin.setFinishedData(encode2String(dataBytes));
    ...
    assertEquals(vauServerErrorData.getData(), "VAUClientSigFin invalid");
  }
}
